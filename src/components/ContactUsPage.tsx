    ...
    <main className="bg-cream text-navy">
      <section className="relative isolate min-h-[680px] overflow-hidden bg-navy pt-[120px] text-cream lg:min-h-[760px] lg:pt-[150px]">
        ...
        <div className="kp-container relative z-[1] grid gap-12 pb-24 lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,0.7fr)] lg:items-end">
          <div>
            <h1 className="max-w-4xl text-[clamp(2.75rem,6.4vw,6.4rem)] font-semibold uppercase leading-[0.98]">
              Contact Nora Wan
            </h1>
            <p className="mt-8 max-w-2xl text-[clamp(1.05rem,1.55vw,1.4rem)] font-light leading-relaxed text-cream/86">
            ...
            {contactDetails.map((detail) => {
              ...
              return (
                <a
                  ...
                  className="group grid gap-2.5 rounded-[14px] bg-cream p-5 text-navy shadow-[0_14px_34px_rgba(56,47,39,0.28)] transition-transform duration-200 hover:-translate-y-1"
                >
