  ...
  return (
    <section id="about" className="py-16 sm:py-20">
      <div className="kp-container grid items-center gap-14 lg:grid-cols-2">
        <div className="kp-reveal flex justify-center" data-reveal="left">
        ...
        <div className="kp-reveal" data-reveal="right" data-reveal-delay="1">
          ...
          <div className="mt-6 space-y-4 font-light leading-relaxed text-navy/80">
            <p>
              Hi, I&rsquo;m Nora Wan a Perth photographer with 15+ years behind the camera
            ...
            <p>
              ...
              huge range of shoots always with relaxed direction, an eye for the genuine
